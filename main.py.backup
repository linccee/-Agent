"""
main.py — Shopping Agent Streamlit Frontend
Aesthetic: Dark Luxe Terminal
All CSS lives in assets/style.css — nothing inline here.
"""
import pathlib
...
st.markdown(
    ...
    <div class="ag-chat-header">
      <h2>🛍️ Shop<span>Agent</span></h2>
      <p>AI 驱动的跨平台购物决策助手 — Google Shopping · Amazon · eBay</p>
    </div>
    """,
...
# ── Chat Input ────────────────────────────────────────────────────────────────
user_input = st.chat_input("告诉我你想买什么，例如：帮我推荐预算¥3000的蓝牙耳机…")
